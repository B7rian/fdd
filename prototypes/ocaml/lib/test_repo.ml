let%test_module _ = (
    module struct
      ...
      let%test "has4" = Repo.has "test4" test_repo
                        = false

      let%test "copy1" = Repo.find_copy file1 test_repo
                         = Some file2
      let%test "copy2" = Repo.find_copy file2 test_repo
                         = Some file1
      let%test "copy3" = Repo.find_copy file3 test_repo
                         = None
      let%test "copy4" = Repo.find_copy file4 test_repo
                         = Some file3
end)
